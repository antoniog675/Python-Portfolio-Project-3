...
<p>This is a very basic version of the actual game, 1 ship takes up 1 point of the board, player will play against the computer, scores will be tracked for the player and a winner is decided when all ships are hit or if player and computer run out of turns.
...
<li>We will also update players with how many turns they have left for the game.</li>
